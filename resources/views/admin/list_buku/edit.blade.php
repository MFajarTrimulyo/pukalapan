...
@section('content')
    ...
    <body>
        ...
        <div class="">
            ...
            <div class="">
                <form action="{{ route('buku.update', $render->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mt-4 mb-2">
                        ...
                        <input type="text" id="kd_buku"
                            ...
                            name="kd_buku" value="{{ old('kd_buku', $render->kd_buku) }}"
                    ...
                    <div class="mt-4 mb-2 ">
                        ...
                        <input type="file" id="imagebuku"
                            ...
                            name="foto" value="{{ old('foto', $render->foto) }}">
                    </div>
                    @error('foto')
                        <div id="error-message"
                            class="bg-red-100 border border-red-400 text-red-700 text-xs mt-4 px-4 py-3 w-72 rounded relative"
                    ...
                    <div class="flex space-x-12">
                        <div class="mt-2 mb-2">
                            ...
                            <input type="text" id="judul"
                                class="w-72 mt-4 p-1 text-brown font-medium border-2 border-brown bg-slate-100 placeholder-brown placeholder-opacity-75"
                                placeholder="Enter your book title here" name="judul_buku"
                                value="{{ old('judul_buku', $render->judul_buku) }}">
                            @error('judul_buku')
                                <div id="error-message"
                        ...
                        <div class="mt-2 mb-2">
                            ...
                            <input type="text" id="author"
                                class="w-72 mt-4 p-1 text-brown font-medium border-2 border-brown bg-slate-100 placeholder-brown placeholder-opacity-75"
                                placeholder="Enter your book author here" name="author"
                                value="{{ old('author', $render->author) }}">
                            @error('author')
                                <div id="error-message"
                                    class="bg-red-100 border border-red-400 text-red-700 text-xs mt-4 px-4 py-3 max-w-full rounded relative"
                                    role="alert">
                            ...
                            <select class="w-72 mt-4 p-1 text-brown font-medium border-2 border-brown bg-slate-100"
                                ...
                                @foreach ($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}"
                                        {{ old('kategoriId', $render->kategoriId) == $kategori->id ? 'selected' : '' }}>
                    ...
                    <div class="flex space-x-6">
                        <div class="mt-2 mb-2">
                            ...
                            <input type="number" id="stock"
                                class="w-72 mt-4 p-1 text-brown font-medium border-2 border-brown bg-slate-100 placeholder-brown placeholder-opacity-75"
                                placeholder="Enter your book title here" name="stock"
                                value="{{ old('stock', $render->stock) }}">
                            @error('stock')
                                <div id="error-message"
                                    class="bg-red-100 border border-red-400 text-red-700 text-xs mt-4 px-4 py-3 max-w-full rounded relative"
                                    role="alert">
                    ...
                    <div class="mt-2 mb-2">
                        ...
                        <textarea
                            ...
                            placeholder="Enter your book synopsis here" name="sinopsis" rows="5">{{ old('sinopsis', $render->sinopsis) }}
                        </textarea>
                    </div>
                    @error('sinopsis')
                        <div id="error-message"
