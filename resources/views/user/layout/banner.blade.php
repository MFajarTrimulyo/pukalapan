...
<div class="swiper main-swiper">
  <div class="swiper-wrapper">
    <div class="swiper-slide" src="{{asset ('img.Gambar2.jpg')}}"  >
    <img src="{{asset ('img/banner.jpg')}}" alt="" style="background-repeat: no-repeat;background-size: cover;background-position: center;">
