...
<section id="selling-products" class="product-store bg-light-grey padding-large">
      <div class="container">
        ...
        <ul class="tabs list-unstyled">
          ...
          <li data-tab-target="#shoes" class="tab">Umum</li>
          <li data-tab-target="#tshirts" class="tab">Pelajaran</li>
          <li data-tab-target="#pants" class="tab">Cerita</li>
          <li data-tab-target="#hoodie" class="tab">Agama</li>
          <li data-tab-target="#outer" class="tab">Sosial</li>
          <li data-tab-target="#jackets" class="tab">Bahasa</li>
          <li data-tab-target="#accessories" class="tab">Sains</li>
          <li data-tab-target="#pants" class="tab">Sejarah</li>
          <li data-tab-target="#hoodie" class="tab">Seni</li>
          <li data-tab-target="#outer" class="tab">Teknologi</li>
          <li data-tab-target="#jackets" class="tab">Filsafat</li>
          <li data-tab-target="#accessories" class="tab">Komik</li>
        </ul>
        <div class="tab-content">
          <div id="all" data-tab-content class="active">
            <div class="row d-flex flex-wrap">
              ...
              <div class="product-item col-lg-3 col-md-6 col-sm-6">
                <div class="image-holder">
                  <img src="{{asset ('asset/images/selling-products16.jpg')}}" alt="Books" class="product-image">
                </div>
                <div class="cart-concern">
                  <div class="cart-button d-flex justify-content-between align-items-center">
                    <button type="button" class="btn-wrap cart-link d-flex align-items-center">add to cart <i class="icon icon-arrow-io"></i>
          ...
          <div id="accessories" data-tab-content>
            <div class="row d-flex flex-wrap">
              ...
              <div class="product-item col-lg-3 col-md-6 col-sm-6">
                <div class="image-holder">
                  <img src="{{asset ('asset/images/selling-products20.jpg')}} alt="Books" class="product-image">
                </div>
                <div class="cart-concern">
                  <div class="cart-button d-flex justify-content-between align-items-center">
                    <button type="button" class="btn-wrap cart-link d-flex align-items-center">add to cart <i class="icon icon-arrow-io"></i>
